...
data = ({('AbstractBaseCreate', 'findAlias'): {'backwards_compatibility_enabled': True},
  ...
  ('BlendShape', 'setWeight'): {'override': True},
  ...
  ('PolyBlindData', 'typeId'): {'enabled': False,
                                'melEnabled': True,
                                'melName': 'setTypeId'},
  ('PolySeparate', 'findAlias'): {'override': True},
  ('PolySeparate', 'getAffectedAttributes'): {'override': True},
  ('PolySeparate', 'getAffectedByAttributes'): {'override': True},
  ('PolySeparate', 'getAliasList'): {'override': True},
  ('PolySeparate', 'getConnections'): {'override': True},
  ('PolySeparate', 'plugsAlias'): {'override': True},
  ('PolySeparate', 'setAlias'): {'override': True},
