...
def adpAssistant(*args, aiAssistant: bool | int = ..., ai: bool | int = ..., updateMCPServer: Tuple[str, int] = ..., mcp: Tuple[str, int] = ...) -> Any: ...
def adpWaypoint(*args, name: _util.ProxyUnicode | str = ..., n: _util.ProxyUnicode | str = ..., property: str | List[str] = ..., p: str | List[str] = ...) -> Any: ...
...
def animContextManager(*args, availableTracks: bool | int = ..., atr: bool | int = ..., cancelMediaDownload: int = ..., cmd: int = ..., clear: bool | int = ..., c: bool | int = ..., clipAvailableTracks: int = ..., cat: int = ..., clipAvailableVersions: Tuple[int, int] = ..., cav: Tuple[int, int] = ..., clipCurrentTrack: int = ..., cct: int = ..., clipCurrentVersion: Tuple[int, int, int] = ..., ccv: Tuple[int, int, int] = ..., clipEndTime: int = ..., cet: int = ..., clipName: int = ..., cn: int = ..., clipStartTime: int = ..., cst: int = ..., currentShotId: _util.ProxyUnicode | str = ..., csi: _util.ProxyUnicode | str = ..., currentShotMode: int = ..., csm: int = ..., currentTrack: int = ..., tr: int = ..., enable: bool | int = ..., en: bool | int = ..., featureAvailable: bool | int = ..., fa: bool | int = ..., hasContext: bool | int = ..., hc: bool | int = ..., hasGap: int = ..., hg: int = ..., hasShotPadding: bool | int = ..., hsp: bool | int = ..., liveEdit: bool | int = ..., le: bool | int = ..., loadTimeline: _util.ProxyUnicode | str = ..., lt: _util.ProxyUnicode | str = ..., mediaDownloadProgress: Tuple[str, int] = ..., dp: Tuple[str, int] = ..., mediaFileURL: Tuple[str, str] = ..., url: Tuple[str, str] = ..., mediaResolved: int = ..., mr: int = ..., numClips: bool | int = ..., nc: bool | int = ..., playbackRange: int = ..., pr: int = ..., query: bool | int = ..., q: bool | int = ..., recentShotMedia: bool | int = ..., rsm: bool | int = ..., referenceTracks: bool | int = ..., rtr: bool | int = ..., reload: bool | int = ..., r: bool | int = ..., replaceShot: Tuple[int, int, int] = ..., rs: Tuple[int, int, int] = ..., retryMediaDownload: int = ..., rmd: int = ..., setDownloadError: Tuple[str, bool | int] = ..., sde: Tuple[str, bool | int] = ..., shotCamera: None | str = ..., sc: None | str = ..., shotIndex: int = ..., si: int = ..., shotMedia: _util.ProxyUnicode | str = ..., sm: _util.ProxyUnicode | str = ..., shotPanel: bool | int = ..., spa: bool | int = ..., shotStartTime: int | float = ..., st: int | float = ..., showDemoDialog: int = ..., sdd: int = ..., showPipelineStepDialog: bool | int = ..., spd: bool | int = ..., showShotPadding: bool | int = ..., ssp: bool | int = ...) -> Any: ...
...
def cutView(*args, annotation: _util.ProxyUnicode | str = ..., ann: _util.ProxyUnicode | str = ..., backgroundColor: Tuple[float, float, float] = ..., bgc: Tuple[float, float, float] = ..., defineTemplate: _util.ProxyUnicode | str = ..., dt: _util.ProxyUnicode | str = ..., docTag: _util.ProxyUnicode | str = ..., dtg: _util.ProxyUnicode | str = ..., dragCallback: callable = ..., dgc: callable = ..., dropCallback: callable = ..., dpc: callable = ..., edit: bool | int = ..., e: bool | int = ..., enable: bool | int = ..., en: bool | int = ..., enableBackground: bool | int = ..., ebg: bool | int = ..., enableKeyboardFocus: bool | int = ..., ekf: bool | int = ..., exists: bool | int = ..., ex: bool | int = ..., fullPathName: bool | int = ..., fpn: bool | int = ..., height: int = ..., h: int = ..., highlightColor: Tuple[float, float, float] = ..., hlc: Tuple[float, float, float] = ..., isObscured: bool | int = ..., io: bool | int = ..., manage: bool | int = ..., m: bool | int = ..., noBackground: bool | int = ..., nbg: bool | int = ..., numberOfPopupMenus: bool | int = ..., npm: bool | int = ..., parent: _util.ProxyUnicode | str = ..., p: _util.ProxyUnicode | str = ..., popupMenuArray: bool | int = ..., pma: bool | int = ..., preventOverride: bool | int = ..., po: bool | int = ..., query: bool | int = ..., q: bool | int = ..., refresh: bool | int = ..., r: bool | int = ..., statusBarMessage: _util.ProxyUnicode | str = ..., sbm: _util.ProxyUnicode | str = ..., useTemplate: _util.ProxyUnicode | str = ..., ut: _util.ProxyUnicode | str = ..., visible: bool | int = ..., vis: bool | int = ..., visibleChangeCommand: callable = ..., vcc: callable = ..., width: int = ..., w: int = ..., widthHeight: Tuple[int, int] = ..., wh: Tuple[int, int] = ...): ...
...
def polySpinEdge(*args, caching: bool | int = ..., cch: bool | int = ..., constructionHistory: bool | int = ..., ch: bool | int = ..., edit: bool | int = ..., e: bool | int = ..., frozen: bool | int = ..., fzn: bool | int = ..., inputComponentsConnection: _util.ProxyUnicode | str = ..., icc: _util.ProxyUnicode | str = ..., name: _util.ProxyUnicode | str = ..., n: _util.ProxyUnicode | str = ..., nodeState: int = ..., nds: int = ..., offset: int = ..., off: int = ..., query: bool | int = ..., q: bool | int = ..., reverse: bool | int = ..., rev: bool | int = ..., useInputComp: bool | int = ..., uic: bool | int = ...) -> Any: ...
...
def workspacePanel(*args, defineTemplate: _util.ProxyUnicode | str = ..., dt: _util.ProxyUnicode | str = ..., edit: bool | int = ..., e: bool | int = ..., exists: bool | int = ..., ex: bool | int = ..., mainWindow: bool | int = ..., mw: bool | int = ..., query: bool | int = ..., q: bool | int = ..., useTemplate: _util.ProxyUnicode | str = ..., ut: _util.ProxyUnicode | str = ...) -> Any: ...
