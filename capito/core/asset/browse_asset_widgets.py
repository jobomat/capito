...
from PySide6.QtGui import QColor, QIcon, QPixmap, Qt, QCursor, QFont  # pylint:disable=wrong-import-order
from PySide6.QtWidgets import QCheckBox  # pylint:disable=wrong-import-order
