...
def transform_outfilename(drawtext, full_path=False):
    ...
    return str(filepath).replace("\\", "/").replace(":", "\:")

def overrides(encoder, **kwargs): #fontsize=None, fontcolor=None, fontfile=None, offset_x=None, offset_y=None, boxcolor=None, boxborderw=None):
    return kwargs
